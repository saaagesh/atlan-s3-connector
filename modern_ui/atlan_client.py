...
def get_atlan_client() -> AtlanClient:
    ...
    if _client is None:
        ...
        if not base_url or not api_key or "your-atlan-base-url" in base_url or "your-atlan-api-key" in api_key:
            raise ValueError(
                "Atlan credentials are not configured correctly. "
                "Please fill in your actual ATLAN_BASE_URL and ATLAN_API_KEY in the flask_app/.env file."
            )
